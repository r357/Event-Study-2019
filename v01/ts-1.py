...
ReadExcel = pd.read_excel ("/Users/Alen/Documents/0_Academic/0_University/2_Magistrski_Studij/3_Semester (2018)/Empirical Asset Pricing/2_Trigav Skladi/v01/ts-01.xlsx", '1beat')
df_beat = DataFrame(ReadExcel,columns=['Date','IB8A_AR', 'QW1A_AR', 'window_beat_CPEXEMUY'])
df_beat.dropna(inplace=True)
#print (df_beat)

ReadExcel = pd.read_excel ('/Users/Alen/Documents/0_Academic/0_University/2_Magistrski_Studij/3_Semester (2018)/Empirical Asset Pricing/2_Trigav Skladi/v01/ts-01.xlsx', '1miss')
df_miss = DataFrame(ReadExcel,columns=['Date','IB8A_AR', 'QW1A_AR', 'window_miss_CPEXEMUY'])
df_miss.dropna(inplace=True)
#print (df_miss)

#IB8A CPEXEMUY beat
timeminus3_beat = df_beat[df_beat.window_beat_CPEXEMUY == -3]
listIB8A_ARminus3_beat = timeminus3_beat['IB8A_AR']
a = sum(listIB8A_ARminus3_beat)
b = len(listIB8A_ARminus3_beat)
c = a/b #AAR_beat(-3)
timeminus2_beat = df_beat[df_beat.window_beat_CPEXEMUY == -2]
listIB8A_ARminus2_beat = timeminus2_beat['IB8A_AR']
d = sum(listIB8A_ARminus2_beat)
e = len(listIB8A_ARminus2_beat)
f = d/e #AAR_beat(-2)
timeminus1_beat = df_beat[df_beat.window_beat_CPEXEMUY == -1]
listIB8A_ARminus1_beat = timeminus1_beat['IB8A_AR']
g = sum(listIB8A_ARminus1_beat)
h = len(listIB8A_ARminus1_beat)
i = g/h #AAR_beat(-1)
timezero_beat = df_beat[df_beat.window_beat_CPEXEMUY == 0]
listIB8A_ARzero_beat = timezero_beat['IB8A_AR']
j = sum(listIB8A_ARzero_beat)
k = len(listIB8A_ARzero_beat)
l = j/k #AAR_beat(0)
timeplus1_beat = df_beat[df_beat.window_beat_CPEXEMUY == 1]
listIB8A_ARplus1_beat = timeplus1_beat['IB8A_AR']
m = sum(listIB8A_ARplus1_beat)
n = len(listIB8A_ARplus1_beat)
o = m/n #AAR(1)
timeplus2_beat = df_beat[df_beat.window_beat_CPEXEMUY == 2]
listIB8A_ARplus2_beat = timeplus2_beat['IB8A_AR']
p = sum(listIB8A_ARplus2_beat)
r = len(listIB8A_ARplus2_beat)
s = p/r #AAR_beat(2)
timeplus3_beat = df_beat[df_beat.window_beat_CPEXEMUY == 3]
...
ax2.set_ylabel(r'CAAR IB8A CPEXEMUY miss')
...
ax3.set_ylabel(r'CAAR QW1A CPEXEMUY beat')
...
ax4.set_ylabel(r'CAAR QW1A CPEXEMUY miss')