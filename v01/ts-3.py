...
ReadExcel = pd.read_excel (r'C:\Users\asus\Documents\Python-Vaje\ts-01.xlsx', '3beat')
df_beat = DataFrame(ReadExcel,columns=['Date','LU13TRUU_AR', 'LU35TRUU_AR', 'LU57TRUU_AR', 'LU71TRUU_AR', 'LU10TRUU_AR', 'LU3ATRUU_AR', 'LU2ATRUU_AR', 'LU1ATRUU_AR', 'LUBATRUU_AR', 'LUACTRUU_AR', 'LUATTRUU_AR', 'window_beat_CPI_CHNG'])
df_beat.dropna(inplace=True)
#print (df_beat)

ReadExcel = pd.read_excel (r'C:\Users\asus\Documents\Python-Vaje\ts-01.xlsx', '3miss')
df_miss = DataFrame(ReadExcel,columns=['Date','LU13TRUU_AR', 'LU35TRUU_AR', 'LU57TRUU_AR', 'LU71TRUU_AR', 'LU10TRUU_AR', 'LU3ATRUU_AR', 'LU2ATRUU_AR', 'LU1ATRUU_AR', 'LUBATRUU_AR', 'LUACTRUU_AR', 'LUATTRUU_AR', 'window_miss_CPI_CHNG'])
df_miss.dropna(inplace=True)
#print (df_miss)

#LU13TRUU CPI CHNG beat
timeminus3_beat = df_beat[df_beat.window_beat_CPI_CHNG == -3]
listLU13TRUU_ARminus3_beat = timeminus3_beat['LU13TRUU_AR']
a = sum(listLU13TRUU_ARminus3_beat)
b = len(listLU13TRUU_ARminus3_beat)
c = a/b #AAR_beat(-3)
timeminus2_beat = df_beat[df_beat.window_beat_CPI_CHNG == -2]
listLU13TRUU_ARminus2_beat = timeminus2_beat['LU13TRUU_AR']
d = sum(listLU13TRUU_ARminus2_beat)
e = len(listLU13TRUU_ARminus2_beat)
f = d/e #AAR_beat(-2)
timeminus1_beat = df_beat[df_beat.window_beat_CPI_CHNG == -1]
listLU13TRUU_ARminus1_beat = timeminus1_beat['LU13TRUU_AR']
g = sum(listLU13TRUU_ARminus1_beat)
h = len(listLU13TRUU_ARminus1_beat)
i = g/h #AAR_beat(-1)
timezero_beat = df_beat[df_beat.window_beat_CPI_CHNG == 0]
listLU13TRUU_ARzero_beat = timezero_beat['LU13TRUU_AR']
j = sum(listLU13TRUU_ARzero_beat)
k = len(listLU13TRUU_ARzero_beat)
l = j/k #AAR_beat(0)
timeplus1_beat = df_beat[df_beat.window_beat_CPI_CHNG == 1]
listLU13TRUU_ARplus1_beat = timeplus1_beat['LU13TRUU_AR']
m = sum(listLU13TRUU_ARplus1_beat)
n = len(listLU13TRUU_ARplus1_beat)
o = m/n #AAR(1)
timeplus2_beat = df_beat[df_beat.window_beat_CPI_CHNG == 2]
listLU13TRUU_ARplus2_beat = timeplus2_beat['LU13TRUU_AR']
p = sum(listLU13TRUU_ARplus2_beat)
r = len(listLU13TRUU_ARplus2_beat)
s = p/r #AAR_beat(2)
timeplus3_beat = df_beat[df_beat.window_beat_CPI_CHNG == 3]
...
ax2.set_ylabel(r'CAAR LU13TRUU CPI CHNG miss')

#LU35TRUU CPI CHNG beat
...
ax3.set_ylabel(r'CAAR LU35TRUU CPI CHNG beat')

#LU35TRUU CPI CHNG miss
...
ax4.set_ylabel(r'CAAR LU35TRUU CPI CHNG miss')

#LU57TRUU CPI CHNG beat
...
ax5.set_ylabel(r'CAAR LU57TRUU CPI CHNG beat')

#LU57TRUU CPI CHNG miss
...
ax6.set_ylabel(r'CAAR LU57TRUU CPI CHNG miss')

#LU71TRUU CPI CHNG beat
...
ax7.set_ylabel(r'CAAR LU71TRUU CPI CHNG beat')

#LU71TRUU CPI CHNG miss
...
ax8.set_ylabel(r'CAAR LU71TRUU CPI CHNG miss')

#LU10TRUU CPI CHNG beat
...
ax9.set_ylabel(r'CAAR LU10TRUU CPI CHNG beat')

#LU10TRUU CPI CHNG miss
...
ax10.set_ylabel(r'CAAR LU10TRUU CPI CHNG miss')

#LU3ATRUU CPI CHNG beat
...
ax11.set_ylabel(r'CAAR LU3ATRUU CPI CHNG beat')

#LU3ATRUU CPI CHNG miss
...
ax12.set_ylabel(r'CAAR LU3ATRUU CPI CHNG miss')

#LU2ATRUU CPI CHNG beat
...
ax13.set_ylabel(r'CAAR LU2ATRUU CPI CHNG beat')

#LU2ATRUU CPI CHNG miss
...
ax14.set_ylabel(r'CAAR LU2ATRUU CPI CHNG miss')

#LU1ATRUU CPI CHNG beat
...
ax15.set_ylabel(r'CAAR LU1ATRUU CPI CHNG beat')

#LU1ATRUU CPI CHNG miss
...
ax16.set_ylabel(r'CAAR LU1ATRUU CPI CHNG miss')

#LUBATRUU CPI CHNG beat
...
ax17.set_ylabel(r'CAAR LUBATRUU CPI CHNG beat')

#LUBATRUU CPI CHNG miss
...
ax18.set_ylabel(r'CAAR LUBATRUU CPI CHNG miss')

#LUATTRUU CPI CHNG beat
...
ax19.set_ylabel(r'CAAR LUATTRUU CPI CHNG beat')

#LUATTRUU CPI CHNG miss
...
ax20.set_ylabel(r'CAAR LUATTRUU CPI CHNG miss')

#LUACTRUU CPI CHNG beat
...
ax21.set_ylabel(r'CAAR LUACTRUU CPI CHNG beat')

#LUACTRUU CPI CHNG miss
...
ax22.set_ylabel(r'CAAR LUACTRUU CPI CHNG miss')