...
ReadExcel = pd.read_excel (r'/Users/Alen/Documents/0_Academic/0_University/2_Magistrski_Studij/3_Semester (2018)/Empirical Asset Pricing/2_Trigav Skladi/v01/ts-01.xlsx', '5beat')
df_beat = DataFrame(ReadExcel,columns=['Date','LU13TRUU_AR', 'LU35TRUU_AR', 'LU57TRUU_AR', 'LU71TRUU_AR', 'LU10TRUU_AR', 'LU3ATRUU_AR', 'LU2ATRUU_AR', 'LU1ATRUU_AR', 'LUBATRUU_AR', 'LUACTRUU_AR', 'LUATTRUU_AR', 'window_beat_PCE_CMOM'])
df_beat.dropna(inplace=True)
#print (df_beat)

ReadExcel = pd.read_excel (r'/Users/Alen/Documents/0_Academic/0_University/2_Magistrski_Studij/3_Semester (2018)/Empirical Asset Pricing/2_Trigav Skladi/v01/ts-01.xlsx', '5miss')
df_miss = DataFrame(ReadExcel,columns=['Date','LU13TRUU_AR', 'LU35TRUU_AR', 'LU57TRUU_AR', 'LU71TRUU_AR', 'LU10TRUU_AR', 'LU3ATRUU_AR', 'LU2ATRUU_AR', 'LU1ATRUU_AR', 'LUBATRUU_AR', 'LUACTRUU_AR', 'LUATTRUU_AR', 'window_miss_PCE_CMOM'])
df_miss.dropna(inplace=True)
#print (df_miss)

#LU13TRUU PCE CMOM beat
timeminus3_beat = df_beat[df_beat.window_beat_PCE_CMOM == -3]
listLU13TRUU_ARminus3_beat = timeminus3_beat['LU13TRUU_AR']
a = sum(listLU13TRUU_ARminus3_beat)
b = len(listLU13TRUU_ARminus3_beat)
c = a/b #AAR_beat(-3)
timeminus2_beat = df_beat[df_beat.window_beat_PCE_CMOM == -2]
listLU13TRUU_ARminus2_beat = timeminus2_beat['LU13TRUU_AR']
d = sum(listLU13TRUU_ARminus2_beat)
e = len(listLU13TRUU_ARminus2_beat)
f = d/e #AAR_beat(-2)
timeminus1_beat = df_beat[df_beat.window_beat_PCE_CMOM == -1]
listLU13TRUU_ARminus1_beat = timeminus1_beat['LU13TRUU_AR']
g = sum(listLU13TRUU_ARminus1_beat)
h = len(listLU13TRUU_ARminus1_beat)
i = g/h #AAR_beat(-1)
timezero_beat = df_beat[df_beat.window_beat_PCE_CMOM == 0]
listLU13TRUU_ARzero_beat = timezero_beat['LU13TRUU_AR']
j = sum(listLU13TRUU_ARzero_beat)
k = len(listLU13TRUU_ARzero_beat)
l = j/k #AAR_beat(0)
timeplus1_beat = df_beat[df_beat.window_beat_PCE_CMOM == 1]
listLU13TRUU_ARplus1_beat = timeplus1_beat['LU13TRUU_AR']
m = sum(listLU13TRUU_ARplus1_beat)
n = len(listLU13TRUU_ARplus1_beat)
o = m/n #AAR(1)
timeplus2_beat = df_beat[df_beat.window_beat_PCE_CMOM == 2]
listLU13TRUU_ARplus2_beat = timeplus2_beat['LU13TRUU_AR']
p = sum(listLU13TRUU_ARplus2_beat)
r = len(listLU13TRUU_ARplus2_beat)
s = p/r #AAR_beat(2)
timeplus3_beat = df_beat[df_beat.window_beat_PCE_CMOM == 3]
...
ax2.set_ylabel(r'CAAR LU13TRUU PCE CMOM miss')

#LU35TRUU PCE CMOM beat
...
ax3.set_ylabel(r'CAAR LU35TRUU PCE CMOM beat')

#LU35TRUU PCE CMOM miss
...
ax4.set_ylabel(r'CAAR LU35TRUU PCE CMOM miss')

#LU57TRUU PCE CMOM beat
...
ax5.set_ylabel(r'CAAR LU57TRUU PCE CMOM beat')

#LU57TRUU PCE CMOM miss
...
ax6.set_ylabel(r'CAAR LU57TRUU PCE CMOM miss')

#LU71TRUU PCE CMOM beat
...
ax7.set_ylabel(r'CAAR LU71TRUU PCE CMOM beat')

#LU71TRUU PCE CMOM miss
...
ax8.set_ylabel(r'CAAR LU71TRUU PCE CMOM miss')

#LU10TRUU PCE CMOM beat
...
ax9.set_ylabel(r'CAAR LU10TRUU PCE CMOM beat')

#LU10TRUU PCE CMOM miss
...
ax10.set_ylabel(r'CAAR LU10TRUU PCE CMOM miss')

#LU3ATRUU PCE CMOM beat
...
ax11.set_ylabel(r'CAAR LU3ATRUU PCE CMOM beat')

#LU3ATRUU PCE CMOM miss
...
ax12.set_ylabel(r'CAAR LU3ATRUU PCE CMOM miss')

#LU2ATRUU PCE CMOM beat
...
ax13.set_ylabel(r'CAAR LU2ATRUU PCE CMOM beat')

#LU2ATRUU PCE CMOM miss
...
ax14.set_ylabel(r'CAAR LU2ATRUU PCE CMOM miss')

#LU1ATRUU PCE CMOM beat
...
ax15.set_ylabel(r'CAAR LU1ATRUU PCE CMOM beat')

#LU1ATRUU PCE CMOM miss
...
ax16.set_ylabel(r'CAAR LU1ATRUU PCE CMOM miss')

#LUBATRUU PCE CMOM beat
...
ax17.set_ylabel(r'CAAR LUBATRUU PCE CMOM beat')

#LUBATRUU PCE CMOM miss
...
ax18.set_ylabel(r'CAAR LUBATRUU PCE CMOM miss')

#LUATTRUU PCE CMOM beat
...
ax19.set_ylabel(r'CAAR LUATTRUU PCE CMOM beat')

#LUATTRUU PCE CMOM miss
...
ax20.set_ylabel(r'CAAR LUATTRUU PCE CMOM miss')

#LUACTRUU PCE CMOM beat
...
ax21.set_ylabel(r'CAAR LUACTRUU PCE CMOM beat')

#LUACTRUU PCE CMOM miss
...
ax22.set_ylabel(r'CAAR LUACTRUU PCE CMOM miss')